...
def csvMapGraph( options, agraphs=None, window=None, displayProp=None,
  ...
  filterExpr=None, min=None, max=None):
  ...
  for ag in agraphs:
    ...
    if palette is not None:
      if isinstance( palette, a.APalette ):
        ...
        ag.setPalette( palette ,minVal=min, maxVal=max, absoluteMode=True)
...
def main():
  ...
  aobjects, wins = csvMapGraph( options , palette=options.palette, min=options.min, max=options.max)
